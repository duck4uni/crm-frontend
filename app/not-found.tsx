...
export default function NotFound() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-950 via-primary-900 to-indigo-800 text-white">
      ...
      <section className="relative z-10 mx-auto flex min-h-screen w-full max-w-4xl items-center px-6 py-16">
        <div className="w-full rounded-3xl border border-white/20 bg-white/10 p-8 shadow-2xl backdrop-blur-md sm:p-10">
          <div className="mb-8 inline-flex items-center gap-3 rounded-full border border-white/20 bg-white/10 px-4 py-2">
            <Image src="/logo.png" alt="CRM" width={32} height={32} className="h-8 w-8 object-contain" priority />
            <span className="text-sm font-semibold text-indigo-100">CRM Dien Lanh</span>
          </div>
          ...
          <div className="grid items-center gap-8 md:grid-cols-[1.2fr,0.8fr]">
            <div>
              ...
              <h1 className="mt-3 text-5xl font-extrabold leading-tight sm:text-6xl">
                Trang bạn tìm
                <span className="block bg-gradient-to-r from-cyan-300 to-indigo-100 bg-clip-text text-transparent">
                  không tồn tại
                </span>
              </h1>
              <p className="mt-4 max-w-xl text-base text-indigo-100/90 sm:text-lg">
            ...
            <div className="relative hidden md:block">
              ...
              <div className="relative rounded-2xl border border-white/20 bg-white/10 p-6">
                ...
                <p className="mt-2 text-sm text-indigo-100/90">Không tìm thấy nội dung theo URL hiện tại</p>
