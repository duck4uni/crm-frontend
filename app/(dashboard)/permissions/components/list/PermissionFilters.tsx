...
const PERMISSION_FILTERS = [
    ...
    { id: PermissionGroup.DEAL, label: "Deal", bgColor: "bg-purple-100", textColor: "text-purple-700", activeBgColor: "bg-purple-600", activeTextColor: "text-white" },
    { id: PermissionGroup.TASK, label: "Task", bgColor: "bg-yellow-100", textColor: "text-yellow-700", activeBgColor: "bg-yellow-600", activeTextColor: "text-white" },
