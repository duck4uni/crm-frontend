...
import type { PhieuChi, Quy } from "@/services/finance/types";

interface Props {
  phieuChi: PhieuChi[];
  quyList: Quy[];
  onCreate: () => void;
  onEdit: (p: PhieuChi) => void;
  onView: (p: PhieuChi) => void;
}

export function PhieuChiTab({ phieuChi, quyList, onCreate, onEdit, onView }: Props) {
  return (
    <>
              ...
              return (
                <tr key={p.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <Badge variant="warning">Đã chi</Badge>
                  </td>
