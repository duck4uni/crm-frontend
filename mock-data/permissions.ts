...
export const mockPermissions: Permission[] = [
    ...
    // Deal permissions
    {
        ...
        name: "Xem deal",
        code: "deal_view",
        description: "Cho phép xem danh sách và chi tiết deal",
    ...
    },
    {
        ...
        name: "Tạo deal",
        code: "deal_create",
        description: "Cho phép tạo deal mới",
        group_code: PermissionGroup.DEAL,
    },
    {
        id: "p11",
        name: "Chỉnh sửa deal",
        code: "deal_edit",
        description: "Cho phép chỉnh sửa thông tin deal",
        group_code: PermissionGroup.DEAL,
    },
    {
        id: "p12",
    ...
    },
    {
        ...
        name: "Tạo task",
        code: "task_create",
        description: "Cho phép tạo task mới",
        group_code: PermissionGroup.TASK,
    },
    {
        id: "p15",
        name: "Chỉnh sửa task",
        code: "task_edit",
        description: "Cho phép chỉnh sửa task",
        group_code: PermissionGroup.TASK,
    },
    // Report permissions
    {
